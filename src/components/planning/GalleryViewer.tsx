        ...
        {showMasterPlan ? (
          ...
          >
            <div ref={containerRef} className="relative w-full h-screen overflow-hidden bg-white pt-16">
              {showNodes && (
                <div className="absolute left-8 lg:left-12 2xl:left-16 top-1/2 -translate-y-1/2 z-10 space-y-0.5 lg:space-y-3 2xl:space-y-4 text-black max-w-xl lg:max-w-2xl 2xl:max-w-3xl">
              ...
              <div className="absolute right-[2%] lg:right-[4%] 2xl:right-[6%] top-0 w-[80%] lg:w-[75%] 2xl:w-[70%] h-full">
                <motion.div
